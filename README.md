...
('VPN Connection Setup', 'To connect to company VPN: 1. Open VPN client 2. Enter credentials 3. Select region 4. Click connect. For issues, check firewall settings.', 'sop', 'vpn,network,access'),
('Password Reset Procedure', 'Password reset steps: 1. Go to portal 2. Click Forgot Password 3. Verify email 4. Create new password with 12+ characters.', 'faq', 'password,security,account'),
('Email Configuration', 'Configure email client: Server: mail.company.com, Port: 993 (IMAP) / 587 (SMTP), Use SSL/TLS encryption.', 'sop', 'email,configuration'),
('Common Login Issues', 'Login troubleshooting: 1. Clear browser cache 2. Check caps lock 3. Reset password if needed 4. Contact IT if blocked.', 'faq', 'login,troubleshooting');

-- Sample Projects Data
INSERT INTO projects (project_name, description, tech_stack, status, start_date) VALUES
('Customer Portal', 'Web application for customer self-service including account management and support tickets', 'React, Node.js, MongoDB, Redis', 'active', '2024-01-15'),
('Mobile App Redesign', 'UI/UX overhaul of mobile application with improved navigation', 'Flutter, Firebase, GraphQL', 'planning', '2024-02-01'),
('API Gateway', 'Centralized API gateway for microservices architecture', 'Kong, Docker, Kubernetes', 'active', '2023-11-20'),
('Analytics Dashboard', 'Real-time analytics dashboard for business intelligence', 'Python, Dash, PostgreSQL', 'completed', '2023-09-10');
```
